...
public class Data {
    ...
    private void CreateList(){
        ...
        this.pasos.get(13).get(0).add("Impresión");
        /////////////////////////////////
        this.pasos.get(13).get(1).add("(menu)");
        this.pasos.get(13).get(1).add("(defun menu()");
        this.pasos.get(13).get(1).add("(print \" 1) Funcion Resta\")");
        this.pasos.get(13).get(1).add("(print \" 2) Funcion Suma\")");
        this.pasos.get(13).get(1).add("(print \"Seleccione una opción: \")");
        this.pasos.get(13).get(1).add("(setq opc (read))");
        this.pasos.get(13).get(1).add("(cond");
        this.pasos.get(13).get(1).add("((= opc 1) ");
        this.pasos.get(13).get(1).add("(resta))");
        this.pasos.get(13).get(1).add("(defun resta()");
        this.pasos.get(13).get(1).add("(print \"funcion de resta\")");
        this.pasos.get(13).get(1).add("((= opc 2)");
        this.pasos.get(13).get(1).add("(suma))");
        this.pasos.get(13).get(1).add("(defun suma()");
        this.pasos.get(13).get(1).add("(print \"funcion de suma\")");
        ////////////////   15    /////////////////
        ...
        this.pasos.get(14).get(0).add("Impresión");
        /////////////////////////////////
        this.pasos.get(14).get(1).add("(menu)");
        this.pasos.get(14).get(1).add("(defun menu()");
        this.pasos.get(14).get(1).add("(print \" 1) Funcion Resta\")");
        this.pasos.get(14).get(1).add("(print \" 2) Funcion Suma\")");
        this.pasos.get(14).get(1).add("(print \" 3) Funcion Multiplicacion\")");
        this.pasos.get(14).get(1).add("(print \"Seleccione una opción: \")");
        this.pasos.get(14).get(1).add("(setq opc (read))");
        this.pasos.get(14).get(1).add("(cond");
        this.pasos.get(14).get(1).add("((= opc 1) ");
        this.pasos.get(14).get(1).add("(suma))");
        this.pasos.get(14).get(1).add("(defun suma()");
        this.pasos.get(14).get(1).add("(print \"ingrese el valor de a\")");
        this.pasos.get(14).get(1).add("(setq a (read))");
        this.pasos.get(14).get(1).add("(print \"ingrese el valor de b\")");
        this.pasos.get(14).get(1).add("(setq b (read))");
        this.pasos.get(14).get(1).add("(print \"La suma es: ~d\" (+ a b))");
        this.pasos.get(14).get(1).add("((= opc 2)");
        this.pasos.get(14).get(1).add("(resta))");
        this.pasos.get(14).get(1).add("(defun resta()");
        this.pasos.get(14).get(1).add("(print \"La resta es: ~d\" (- a b))");
        this.pasos.get(14).get(1).add("((= opc 3)");
        this.pasos.get(14).get(1).add("(multiplicacion))");
        this.pasos.get(14).get(1).add("(defun multiplicacion()");
        this.pasos.get(14).get(1).add("(print \"La multiplicacion es: ~d\" (* a b))");
        /*
        ////////////////   N    /////////////////
